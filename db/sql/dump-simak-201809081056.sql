...
INSERT INTO `admin_preferences` VALUES (1,1,0,1,1,0,1,1,0);
...
INSERT INTO `course` VALUES (1,'A01','Rekayasa Perangkat Lunak'),(2,'A02','Algoritma dan Pemrograman'),(4,'A04','Ubah'),(6,'A06','Database'),(7,'A11','Baru');
...
INSERT INTO `users` VALUES (1,'127.0.0.1','administrator','$2a$07$SeBknntpZror9uyftVopmu61qg0ms8Qv1yV6FG.kQOSM.9QhmTo36','','admin@admin.com','',NULL,NULL,'oP6eT07dJgFpODGPQtJM/O',1268889823,1536378575,1,'Admin','istrator','ADMIN','0'),(2,'::1','member mem','$2y$08$yLUK6Bkqg9QuRm1kbSMWH.2gryb2p2YMSi79V4023bCXRrLdwfR9m',NULL,'member@member.com',NULL,NULL,NULL,NULL,1519492342,1519492746,1,'Member','Mem','Zen','1248985235778');
...
--
-- Dumping routines for database 'simak'
--
