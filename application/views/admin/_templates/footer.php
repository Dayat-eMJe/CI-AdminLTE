...
?>
            ...
            <footer class="main-footer">
                ...
                <strong><?php echo lang('footer_copyright'); ?> &copy; 2019-<?php echo date('Y'); ?> <a href="https://matapanda-crew.blogspot.com" target="_blank">Mata Panda Crew</a>  </strong> <?php echo lang('footer_all_rights_reserved'); ?>.
            </footer>
        </div>
